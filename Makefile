...
test:
	docker run --rm -u gradle -v ${PWD}:/home/gradle/project -w /home/gradle/project gradle:${GRADLE_VERSION} gradle test
...
build: # Build using Gradle official Docker image
	...
	docker run --rm -u gradle -v ${PWD}:/home/gradle/project -w /home/gradle/project gradle:${GRADLE_VERSION} gradle build --stacktrace
